...
3. 收集完毕后，分析需求池，与用户逐条交互确认优先级与可行性，从中挑选适合下一个版本的内容，写入 `.claude/docs/todo.md` 作为该版本目标；todo 中每个版本条目须包含版本简介和详细文档链接，并标注当前状态「进行中 / 已完成」，开发过程中实时更新
4. 分析 todo 中的版本需求，与用户交互确认细节，编写对应的详细版本文档
5. 开发过程中，每完成详细文档中的一个步骤，立即提交 git 并更新 `.claude/docs/changelog.md`
